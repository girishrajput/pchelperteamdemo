      ...
      <div className="max-w-6xl mx-auto">
        <div className="p-4 md:p-0 md:flex items-center">
          <div className="w-full md:w-1/4">
            <div className="text-center lg:text-left">
              ...
              <p className="text-sm text-gray-500">Based on <span className="underline font-bold text-gray-900">109 reviews</span></p>
              <div className="mt-2 text-2xl font-bold text-gray-400">
                <Link href="https://share.google/t8GcZpBTaoH5FJpQX" target="_blank" rel="noopener noreferrer">
                  <img src="/images/google.svg" width="130" height="auto" alt="" className='mx-auto md:mx-0' />
                </Link>
              </div>
            </div>
          </div>
          <div className="w-full md:w-3/4">
            <div className=" google-review-section">
              ...
              <div className="elfsight-app-b85d2ae7-f4a7-4348-9fad-68467d3cd45b" data-elfsight-app-lazy></div>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 md:p-0 md:flex items-top gap-4">
          <div className="w-full md:w-1/4">
            <div className="text-center lg:text-left">
              ...
              <div className="flex justify-center lg:justify-start gap-1 mb-2">
                {[...Array(5)].map((_, i) => <Star key={i} fill="#ff0000" className="w-5 h-5 text-red-600" />)}
              </div>
              <p className="text-sm text-gray-500">Based on <span className="underline font-bold text-gray-900">47 reviews</span></p>
              <div className="mt-2 text-red-600 font-black text-3xl italic">
                <Link href="https://www.yelp.com/biz/pchelperteam-los-angeles-3" target="_blank" rel="noopener noreferrer">
                  <img src="/images/yelp.svg" alt="" className='mx-auto md:mx-0 mb-5 md:mb-0' />
                </Link>
              </div>
            </div>
          </div>
          <div className="w-full md:w-3/4">
            <div className="google-review-section">
              <script src="https://elfsightcdn.com/platform.js" async></script>
              <div className="elfsight-app-bd90ae06-4f4e-49b0-9213-235e2f2ab9a5" data-elfsight-app-lazy></div>
            </div>
          </div>
        </div>
